...
from evaluations import evaluate_glue_kernel
from inferences import inference_glue_kernel
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [-1, 0] and args.logging_steps > 0 and global_step % args.logging_steps == 0:
                    ...
                    if (
                        ...
                        results_all = evaluate_glue_kernel(args, model, tokenizer)
                        evg_metric_all = 0
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        for infer_threshold in infer_threshold_list:
            ...
            for checkpoint in checkpoints:
                ...
                result, speed_up, exit_layer_every_ins = evaluate_glue_kernel(args, model, tokenizer, prefix=prefix, eval_highway=True, infer_threshold=infer_threshold)
                res_for_display = {}
                ...
                if result[metric_key] > best:
                    ...
                    infer_speed_up = inference_glue_kernel(args, model, tokenizer, prefix=prefix, eval_highway=True, infer_threshold=infer_threshold)
