...
def evaluate_elue_kernel(args, model, tokenizer, prefix="", eval_highway=False, infer_threshold=0.):
...
def evaluate_glue_kernel(args, model, tokenizer, prefix="", eval_highway=False, infer_threshold=0.):
    model.elasticbert.set_infer_threshold(infer_threshold)
    model.elasticbert.set_eval_state(eval_highway)
    model.elasticbert.reset_stats()
